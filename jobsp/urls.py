...
from pjob.views import (skill_location_wise_fresher_jobs, skill_fresher_jobs,
                        ...
                        jobposts_by_date, week_calendar, job_locations, set_password,
                        job_skills, job_detail, year_calendar, calendar_add_event,
                        calendar_event_list, month_calendar, recruiters,
...
urlpatterns = [
    ...
    url(r'^(?P<job_title_slug>[a-z0-9-.,*?]+)-(?P<job_id>([0-9])+)/$', job_detail, name="job_detail"),
    url(r'^(?P<skill_name>[-\w]+)-fresher-jobs-in-(?P<city_name>[-\w]+)/$',
        skill_location_wise_fresher_jobs, name="skill_location_wise_fresher_jobs"),
    url(r'^(?P<skill_name>[-\w]+)-fresher-jobs-in-(?P<city_name>[-\w]+)/(?P<page_num>[0-9]+)/$',
        skill_location_wise_fresher_jobs),

    url(r'^internship-jobs-in-(?P<location>[-\w]+)/$', city_internship_jobs, name="city_internship_jobs"),
    url(r'^internship-jobs-in-(?P<location>[-\w]+)/(?P<page_num>[0-9]+)/$', city_internship_jobs),

    url(r'^fresher-jobs-in-(?P<city_name>[-\w]+)/$', location_fresher_jobs, name="location_fresher_jobs"),
    url(r'^fresher-jobs-in-(?P<city_name>[-\w]+)/(?P<page_num>[0-9]+)/$', location_fresher_jobs, name="location_fresher_jobs"),

    url(r'^(?P<skill_name>[-\w]+)-jobs-in-(?P<city_name>[-\w]+)/$', custome_search, name="custome_search"),
    url(r'^(?P<skill_name>[-\w]+)-jobs-in-(?P<city_name>[-\w]+)/(?P<page_num>[0-9]+)/$', custome_search),
    url(r'^(?P<skill_name>[-\w]+)-walkins-in-(?P<city_name>[-\w]+)/$', custom_walkins, name="custom_walkins"),
    url(r'^(?P<skill_name>[-\w]+)-walkins-in-(?P<city_name>[-\w]+)/(?P<page_num>[0-9]+)/$', custom_walkins),
    url(r'^(?P<skill_name>[-\w]+)-fresher-jobs/$', skill_fresher_jobs, name="skill_fresher_jobs"),
    url(r'^(?P<skill_name>[-\w]+)-fresher-jobs/(?P<page_num>[0-9]+)/$', skill_fresher_jobs),
    url(r'^(?P<skill_name>[-\w]+)-walkins/(?P<page_num>[0-9]+)/$', skill_location_walkin_jobs),
    url(r'^(?P<skill_name>[-\w]+)-walkins/$', skill_location_walkin_jobs, name="skill_walkin_jobs"),
    url(r'^walkins-in-(?P<skill_name>[-\w]+)/(?P<page_num>[0-9]+)/$', skill_location_walkin_jobs),
    url(r'^walkins-in-(?P<skill_name>[-\w]+)/$', skill_location_walkin_jobs, name="location_walkin_jobs"),
    ...
    url(r'^applicant-unsubscribe/(?P<email>[\w.%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4})/$',
        applicant_unsubscribe, name="applicant_unsubscribe"), url(r'^skill-auto/$', skill_auto_search),

    url(r'^unsubscribe_email/(?P<email_type>([a-z0-9-])+)/(?P<message_id>[a-zA-Z0-9_-]+.*?)/$',
        applicant_email_unsubscribing, name="applicant_email_unsubscribing"),
    url(r'^email-unsubscribe/(?P<message_id>[a-zA-Z0-9_-]+.*?)/$',
    ...
    url(r'registration/using_email/$',
    ...
    url(r'^user/set_password/(?P<user_id>[0-9]+)/(?P<passwd>[a-zA-Z0-9]+)/$', set_password, name="set_password"),
    url(r'^user/activation/(?P<user_id>[a-zA-Z0-9]+)/$',
    ...
    url(r'^recruiters/(?P<recruiter_name>[a-zA-Z0-9_-]+.*?)/(?P<page_num>[0-9]+)/$',
        recruiter_profile),
    url(r'^recruiters/(?P<recruiter_name>[a-zA-Z0-9_-]+.*?)/$',
        recruiter_profile, name="recruiter_profile"),

    url(r'^(?P<job_type>[-\w]+)-jobs-by-skills/$', fresher_jobs_by_skills, name="fresher_jobs_by_skills"),
    url(r'^(?P<job_type>[-\w]+)-by-location/$', jobs_by_location, name="jobs_by_location"),
    ...
    url(r'^assessment/question/view/(?P<que_id>[0-9]+)/$', question_view, name="question_view"),
    url(r'^assessment-questions/$', assessments_questions, name="assessments_questions"),
    ...
    url(r'^(?P<company_name>[-\w]+)-job-openings/(?P<page_num>[0-9]+)/$', each_company_jobs),
    url(r'^(?P<company_name>[-\w]+)-job-openings/$', each_company_jobs, name="company_jobs"),

    url(r'^(?P<industry>[-\w]+)-industry-jobs/$', job_industries, name="job_industries"),
    url(r'^(?P<industry>[-\w]+)-industry-jobs/(?P<page_num>[0-9]+)/$', job_industries),
    url(r'^jobs-for-(?P<industry>[-\w]+)-industry/$', job_industries),
    url(r'^jobs-for-(?P<industry>[-\w]+)-industry/(?P<page_num>[0-9]+)/$', job_industries),
    ...
    url(r'jobposts/year/(?P<year>\w{0,})/month/(?P<month>\w{0,})/date/(?P<date>\w{0,})/$',
        jobposts_by_date, name="jobposts_by_date"),
    url(r'jobposts/year/(?P<year>\w{0,})/month/(?P<month>\w{0,})/date/(?P<date>\w{0,})/(?P<page_num>[0-9]+)/$',
        jobposts_by_date),


    url(r'calendar/(?P<year>\w{0,})/month/(?P<month>\w{0,})/week/(?P<week>\w{0,})/$',
    ...
    url(r'calendar/(?P<year>\w{0,})/month/(?P<month>\w{0,})/$',
    ...
    url(r'^(?P<obj_type>([a-z0-9-])+)/verification/(?P<obj_id>[a-zA-Z0-9_-]+.*?)/$',
