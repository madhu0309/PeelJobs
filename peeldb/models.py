...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def related_jobs(self):
        ...
        related_jobs = JobPost.objects.filter(Q(status='Live') & Q(skills__in=user_skills) | Q(location__in=[self.current_city])).exclude(id__in=ids)
...
class Facebook(models.Model):
    user = models.ForeignKey(User, related_name='facebook_user', on_delete=models.CASCADE)
